...
start
        ...
        movlf     B'00', state1     ;not present
        movlf     B'01', state2     ;pass
        movlf     B'11', state3     ;flicker fail
        movlf     B'11', state4     ;flicker fail
        movlf     B'01', state5     ;pass
        movlf     B'01', state6     ;pass
        movlf     B'01', state7     ;pass
        movlf     B'11', state8     ;flicker fail
        movlf     B'00', state9     ;not present
        movlf     D'0', num_LF
        movlf     D'2', num_FF
        movlf     D'7', num_tot
...
check_for_fail  ;lists all candles that have status currently in W
    movwf           statetemp
one
    subwf           state1, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            two
    writenum        0x1
    spacebar
two
    movf            statetemp, W
    subwf           state2, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            three
    writenum        0x2
    spacebar
three
    movf            statetemp, W
    subwf           state3, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            four
    writenum        0x3
    spacebar
four
    movf            statetemp, W
    subwf           state4, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            five
    writenum        0x4
    spacebar
five
    movf            statetemp, W
    subwf           state5, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            six
    writenum        0x5
    spacebar
six
    movf            statetemp, W
    subwf           state6, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            seven
    writenum        0x6
    spacebar
seven
    movf            statetemp, W
    subwf           state7, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            eight
    writenum        0x7
    spacebar
eight
    movf            statetemp, W
    subwf           state8, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            nine
    writenum        0x8
    spacebar
nine
    movf            statetemp, W
    subwf           state9, W          ;defective state1 = W
    btfss           STATUS,Z
    goto            end_check_fail
    writenum        0x9
end_check_fail
...
; Eventually this will export data to external source
