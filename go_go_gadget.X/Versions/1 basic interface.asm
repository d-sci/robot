...
;***************************************
    ...
    ORG       0x000             ;RESET vector must always be at 0x00
...
start
        ;code to start the timer should go here
        call        Clear_Display
        Display     Start_Msg

        ; just shitting around for now
        call        HalfS
        call        Clear_Display
        writenum    0x5
        call        HalfS
        ...
        ;code to stop the timer should go here
        call       Clear_Display
        Display    End_Msg
        call       HalfS
        call       time
...
big_number      
    ...
    movlf   8, count                      ;will shift 8 times
    clrf    huns
    clrf    tens
    clrf    ones
