...
init
        ...
        clrf      TRISA                 ; PortA *may* be used for motor
        ...
        movlf     b'00011000', TRISC    ; PortC[4:3] is RTC; [7:6] is RS-232; [2:1] *may* be solenoid
        clrf      TRISD                 ; PortD[2:7] is LCD output (rest unused)
        movlf     b'011', TRISE         ; PortE *may* be used for ir and photodata
